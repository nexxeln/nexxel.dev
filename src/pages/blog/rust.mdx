...
By embracing immutability as a default and using mutable variables only when necessary, Rust code becomes more robust and predicatable.
...
![Exhaustive pattern matching](<https://us-east-1.tixte.net/uploads/nexxel-has.no-friends.xyz/Alacritty-v0.10.0-portable_(1)_VPpISCD8Jv.png>)
...
![largest function works](<https://us-east-1.tixte.net/uploads/nexxel-has.no-friends.xyz/Alacritty-v0.10.0-portable_(1)_owuuiwwtmI.png>)
