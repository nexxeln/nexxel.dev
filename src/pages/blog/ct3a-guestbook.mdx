...
<br />
Now merge this router in the main `appRouter`. ```ts // src/server/trpc/router/_app.ts
...
If you want to learn more about this code example, you can read about optimistic updates with `react-query` [here](https://react-query-v3.tanstack.com/guides/optimistic-updates).
