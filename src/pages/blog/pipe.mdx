...
![First iteration of pipe function works!](<https://us-east-1.tixte.net/uploads/nexxel.needs.rest/Alacritty-v0.10.0-portable_(1)_csN4l17Yqf.png>)
...
![Type of returned value is any](<https://us-east-1.tixte.net/uploads/this-vegetable.is-from.space/Alacritty-v0.10.0-portable_(1)_bsSjmmSE39.png>)
...
![Type of returned value is inferred correctly](<https://us-east-1.tixte.net/uploads/this-vegetable.is-from.space/Alacritty-v0.10.0-portable_(1)_T7Vnqd1kYN.png>)
...
![No error when passing a string to a function that expects a number](<https://us-east-1.tixte.net/uploads/this-vegetable.is-from.space/Alacritty-v0.10.0-portable_(1)_ugX7Y8OmQc.png>)
...
![Types working correctly](<https://us-east-1.tixte.net/uploads/nexxel.needs.rest/Alacritty-v0.10.0-portable_(1)_bn9nOVbkO0.png>)
...
![Everything still works!](<https://us-east-1.tixte.net/uploads/this-vegetable.is-from.space/Alacritty-v0.10.0-portable_(1)_8WZ9RDzVlD.png>)
