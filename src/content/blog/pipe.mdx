...
![First iteration of pipe function works!](/images/pipe/first.png)
...
![Type of returned value is any](/images/pipe/any.png)
...
![Type of returned value is inferred correctly](/images/pipe/correct.png)
...
![No error when passing a string to a function that expects a number](/images/pipe/no-error.png)
...
![Types working correctly](/images/pipe/overloading.png)
...
![Everything still works!](/images/pipe/overloading-arrow.png)
