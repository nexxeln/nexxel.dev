...
In the example above, you'll probably want to add some of your own functionality in the `middlware` function. For example, you might want to fetch your user from your database, and then pass that info to onUploadComplete. I didn't show specifics here as the exact flow depends a lot on what your Schema and Auth solution and look like.
