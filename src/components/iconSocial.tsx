...
const IconSocial = () => {
  const icons = [
    ...
    // },
    {
      href: "https://davidadarme.medium.com",
      ariaLabel: "Medium",
      title: "Medium",
      svgPath:
