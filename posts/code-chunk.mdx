...
I found [this paper](https://arxiv.org/abs/2506.15655v2) from CMU called "cAST: Enhancing Code Retrieval-Augmented Generation with Structural Chunking via Abstract Syntax Tree". The core idea is elegant:
...
<Table ascii data={{
  headers: ["", "Duration", "Tokens", "Cost", "Tool Calls"],
  rows: [
