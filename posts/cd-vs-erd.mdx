...
layout: post
author: David Adarme
title: "UML: ¿Cuál es la diferencia entre CD y ERD?"
author: David Adarme
...
description: En primer término, los diagramas en el desarrollo son sumamente fundamentales al ejecutar proyectos, dado que nos sirven para simplificar y dividir procedimientos complejos en componentes mínimos debido a su formato gráfico. Una de las necesidades de los desarrolladores para realizar bosquejos y diagramas es poder encontrar problemas en una etapa inicial y no en producción, por ende éstos apoyan el mejoramiento de la calidad del software y el uso de buenas prácticas.
language: español
substack: "https://substack.com/@davidadarme/note/p-166180630?utm_source=notes-share-action&r=3wz47d"
medium: "https://davidadarme.medium.com/uml-cu%C3%A1l-es-la-diferencia-entre-cd-y-erd-8f2f6298ba8a"
---
