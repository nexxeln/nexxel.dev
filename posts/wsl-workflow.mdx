...
![Screenshot of my terminal](/images/wsl-workflow/terminal.png)
...
![Startship prompt](/images/wsl-workflow/starship.png)
...
![Typed website and I'm in my tmux workspace](/images/wsl-workflow/tmux.gif)
...
![Screenshot of Neovim auto-importing useEffect from React](/images/wsl-workflow/auto-import.png)

![Screenshot of telescope file finder in Neovim](/images/wsl-workflow/telescope.png)
...
![ls -la command](/images/wsl-workflow/ls-la.png)

![with exa](/images/wsl-workflow/exa.png)
