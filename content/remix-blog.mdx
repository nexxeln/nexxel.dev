...
excerpt: "In this blog, we'll create and deploy a simple personaly blog using Remix!"
cover_image: "https://res.cloudinary.com/practicaldev/image/fetch/s--zN_j9vcC--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xilhpk6n5grvzbnyh3pk.png"
---
...
```mdx:app/routes/blog/first-blog.mdx
# First Blog post
```
...
Now let's paste an actual blog post in here. You can write your own blog. If you don't have a blog prepared, for now you can just copy [this blog](https://raw.githubusercontent.com/nexxeln/remix-blog/main/app/routes/blog/go-gol.mdx) to follow along.
...
Then go to [Vercel](https://vercel.com) and login in with GitHub. Click on new project. ![vercel](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_fusvFkqV31.png)
Import the repository that you uploaded the code to. ![vercel-import](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_wmScEKFQZ4.png)
