...
The icons aren't showing up here because you need a [nerd font](https://github.com/ryanoasis/nerd-fonts) for that. If you set up a Nerd Font (I recommend JetBrains Mono), and copy this configuration, you'll get a very minimal looking prompt like this. For more information on configuring Starship, you can look at the docs [here](https://starship.rs/config/).

![Startship prompt](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_jS3SFqMm0V.png)
...
![Typed website and I'm in my tmux workspace](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_4o6jA67dhy.gif)
...
![Screenshot of Neovim auto-importing useEffect from React](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_QbDZP3dZbv.png)

![Screenshot of telescope file finder in Neovim](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_c2klZUhRLU.png)
...
![ls -la command](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_es6V6y6yIo.png)

![with exa](https://us-east-1.tixte.net/uploads/nexxel.needs.rest/brave_qNXvN9cMHy.png)
