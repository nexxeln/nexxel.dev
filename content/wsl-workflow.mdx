...
I use [Ubuntu](https://ubuntu.com/), it is the default distribution that is installed with `WSL`. Ubuntu is really simple to use and has a huge community so getting support is very easy. I highly recommend it for anyone who wants to start using Linux and get familiar with basic Linux commands.
